...
# Define robust settings for laptops and catch-up on wake
...
Register-ScheduledTask -TaskName "InvestAgents_NewsFunnel_Fetch" -Action $ActionFetch -Trigger $TriggerFetch -Settings $TaskSettings -Description "Fetches news candidates hourly without calling LLM" -Force
...
Register-ScheduledTask -TaskName "InvestAgents_NewsFunnel_Triage" -Action $ActionTriage -Trigger $TriggersTriage -Settings $TaskSettings -Description "Triages accumulated news candidates twice daily" -Force
...
Register-ScheduledTask -TaskName "InvestAgents_NewsFunnel_Morning" -Action $ActionMorning -Trigger $TriggerMorning -Settings $TaskSettings -Description "Synthesizes morning macro news digest" -Force
...
Register-ScheduledTask -TaskName "InvestAgents_NewsFunnel_Evening" -Action $ActionEvening -Trigger $TriggerEvening -Settings $TaskSettings -Description "Synthesizes evening macro news digest" -Force
