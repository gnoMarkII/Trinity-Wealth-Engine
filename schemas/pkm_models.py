...
class MemoryEntry(BaseModel):
    ...
    entity_type: str = Field(description="ประเภทของ entity ที่บันทึก เลือกจาก: 'Company', 'Executive', 'Macro_Event', 'Strategy', 'Concept', 'Asset', 'Person', 'Organization', 'Market_Data'")
