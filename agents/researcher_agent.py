...
from tools.knowledge_tools import ingest_article_url, ingest_pdf
from tools.youtube_tools import ingest_youtube_transcript
...
- สุขภาพการเงิน / หนี้สิน / สภาพคล่อง / Free Cash Flow / Operating Cash Flow / Debt/Equity / Current Ratio → เรียก ingest_financial_health พร้อมระบุ ticker + market
